 ...
 * Generated at: 2024-10-23 09:56:07 UTC
...
public final class list_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/inc/session_auth.jspf", Long.valueOf(1729663764380L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
   ...
   String contextPath = request.getContextPath();
      ...
      out.write("    <li><a href=\"/jspPro/cstvsboard/list.htm\">게시판</a></li>\r\n");
      out.write("  </ul>\r\n");
      out.write("</header>\r\n");
      out.write("<div>\r\n");
      ...
      out.write("  <select id=\"cmbNumberPerPage\" name=\"cmbNumberPerPage\" style=\"margin: 10px\">\r\n");
      out.write("  </select>\r\n");
      out.write("  <script>\r\n");
      out.write("   for (var i = 10; i <= 50; i+=5) {\r\n");
      out.write("    $(\"#cmbNumberPerPage\").append(`<option>${i}</option>`);		\r\n");
      out.write("   }\r\n");
      out.write("   // \r\n");
      out.write("   $(\"#cmbNumberPerPage\").on(\"change\", function (){\r\n");
      out.write("       // location.href = `");
      out.print( contextPath );
      out.write("/cstvsboard/list.htm?np=${$(\"#cmbNumberPerPage\").val()}`\r\n");
      out.write("	   let npp = $(this).val();\r\n");
      out.write("       location.href = `/jspPro/cstvsboard/list.htm?numberPerPage=${ npp }`;\r\n");
      out.write("   } );\r\n");
      out.write("   \r\n");
      out.write("   $(\"#cmbNumberPerPage\").val(\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ pvo.numberPerPage}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\")\r\n");
      out.write("   </script>\r\n");
      out.write("  <table>\r\n");
      out.write("    <thead>\r\n");
              ...
              if (_jspx_eval_c_005fotherwise_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                do {
                  ...
                  try {
                    ...
                    // /days04/board/list.jsp(72,9) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
                    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/days04/board/list.jsp(72,9) '${ list }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${ list }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
                    // /days04/board/list.jsp(72,9) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                    ...
                    try {
                      ...
                      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
                        do {
                          ...
                          out.write("</td>\r\n");
                          out.write("             <td><a class=\"title\" href=\"");
                          out.print( contextPath);
      ...
      out.write("<script>\r\n");
      out.write("	     $(\"a.title\").attr(\"href\", function (index, oldHref){\r\n");
      out.write("	        let npp = ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ pvo.numberPerPage }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(";\r\n");
      ...
      out.write("          \r\n");
      out.write("          <script>\r\n");
      out.write("            $(\".pagination a:not(.active)\").attr(\"href\", function (index, oldHref){\r\n");
      out.write("            	let npp = ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ pvo.numberPerPage }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(";\r\n");
      out.write("            	let sc = '");
      ...
      out.write("';\r\n");
      out.write("            	return `/jspPro/cstvsboard/list.htm?currentPage=${ oldHref }&numberPerPage=${npp}&searchCondition=${sc}&searchWord=${sw}`;\r\n");
      out.write("            });\r\n");
      out.write("          </script>\r\n");
      out.write("        </td>\r\n");
      out.write("     </tr>\r\n");
      ...
      out.write("             <option value=\"t\" selected=\"selected\"> title</option>\r\n");
      out.write("             <option value=\"c\">content</option>\r\n");
      out.write("             <option value=\"w\"> writer</option>\r\n");
      out.write("             <option value=\"tc\">title+content</option>\r\n");
      out.write("           </select>\r\n");
      out.write("           <input type=\"text\" name=\"searchWord\" id=\"searchWord\"/>\r\n");
      out.write("           <input type=\"submit\" value=\"search\" />     \r\n");
      out.write("           ");
      out.write("<input type=\"hidden\" name=\"numberPerPage\" value=\"");
      ...
      out.write("  \r\n");
      out.write("  <script>\r\n");
      out.write("    // list.htm?write=success or fail\r\n");
      out.write("    if('");
      ...
      out.print( request.getParameter("write"));
      out.write("' == 'fail'){\r\n");
      out.write("    	alert(\"글 쓰기 실패!!!\");\r\n");
      out.write("    }		 \r\n");
      out.write("    		 \r\n");
      out.write("  </script>\r\n");
      out.write("  <script>\r\n");
      out.write("     // 검색조건, 검색어 상태 유지\r\n");
      out.write("     $(\"#searchCondition\").val('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ empty param.searchCondition ? \"t\" : param.searchCondition}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("');\r\n");
      out.write("     \r\n");
  ...
  private boolean _jspx_meth_c_005fwhen_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /days04/board/list.jsp(66,7) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /days04/board/list.jsp(95,12) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ pvo.prev }", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /days04/board/list.jsp(99,12) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /days04/board/list.jsp(99,12) name = end type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /days04/board/list.jsp(99,12) name = step type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setStep(1);
      // /days04/board/list.jsp(99,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fwhen_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f1, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /days04/board/list.jsp(101,17) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fwhen_005f1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ i eq pvo.currentPage }", boolean.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /days04/board/list.jsp(109,12) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
