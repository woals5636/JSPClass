 ...
 * Generated at: 2024-10-17 01:15:01 UTC
	...
	try{
		...
		if( rs.next() ){
			...
			do{
				...
				p_deptno = rs.getInt("deptno");
				
				evo = new EmpVO().builder()
						.empno(empno).ename(ename).job(job).mgr(mgr)
						.hiredate(hiredate).sal(sal).comm(comm).deptno(p_deptno)
						.build();
      ...
      out.write("\r\n");
      out.write("  	 	<tr>\r\n");
      out.write("  	 	 <td><input type=\"checkbox\" name=\"ckb_\" id=\"ckb_\"></td>\r\n");
      out.write("  	 	 <td>");
      ...
      out.write("	$(\"#deptno\").on(\"change\",function(){\r\n");
      out.write("		// alert(test);\r\n");
      out.write("		let deptno = $(this).val();\r\n");
      out.write("		location.href = `");
      out.print( contextPath);
      out.write("/days03/test01.jsp?deptno=${deptno})`;\r\n");
      out.write("	});\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
