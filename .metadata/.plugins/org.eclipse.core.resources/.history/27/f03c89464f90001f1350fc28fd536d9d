...
<div>
  <xmp class="code">
  	...
  	days06 폴더 안에 있는 파일명을 읽어오고 select 태그에 option 태그를 만들어서 추가
  	
  	하나의 option 태그를 선택하면 그 파일의 내용을 출력....
  </xmp>
  ...
  <%
  	...
  	// System.out.println("> prealPathath: " + realPath);
  	/* C:\Class\Workspace\JSPClass\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\jspPro\days06 */
