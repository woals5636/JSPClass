...
<div>
  ...
  <a href="ex02_oracle_input.jsp">맛집 등록</a>
  <br>
...
<script async="true" defer src="https://maps.googleapis.com/maps/api/js?key=key=AIzaSyC5qGXAOFrxUVGO0-7Xhe9nfHm45ZcgoYw&callback=myMap"></script>
